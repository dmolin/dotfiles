...
-- 25 min
local pomodoro_time = 60 * 50

local pomodoro_image_path = beautiful.pomodoro_icon or awful.util.getdir("config") .."/icons/status/symbolic/alarm-symbolic.svg"

-- setup widget
local pomodoro = wibox.layout.margin(wibox.widget({
