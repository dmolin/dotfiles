...
awful.screen.connect_for_each_screen(function(s)
	...
	s.mywibox:setup({
		...
		{ -- Right widgets
			...
			net_speed_widget(),
			weather_api_widget({
				api_key = "162d59f03cf3470bb4470044241109",
				-- api_key = os.getenv("WEATHERAPI_KEY"),
				coordinates = { 51.268039, 1.062264 },
			}),
			volume_widget({
				widget_type = "icon_and_text",
			}),
			battery_widget({
				path_to_icons = "/home/user/.config/awesome/icons/Arc/status/symbolic/",
			}),
			-- mykeyboardlayout,
			mytextclock,
...
globalkeys = gears.table.join(
	...
	awful.key({ modkey }, "BackSpace", function()
		awful.spawn("/home/user/.config/awesome/powermenu.sh")
  ...
  --]]
	...
	awful.key({}, "Print", function()
		awful.spawn("flameshot gui -c -p /home/user/Pictures")
	end, { description = "Grab Screenshot", group = "media" }),

	awful.key({}, "Pause", function()
		awful.spawn("/home/user/.config/qtile/volume-set.sh 2%+")
	...
	end, { description = "focus on CENTER screen", group = "screen" }),

	awful.key({ modkey }, "Left", function()
		awful.screen.focus(3)
	end, { description = "focus on LEFT screen", group = "screen" }),

	awful.key({ modkey }, "Right", function()
		awful.screen.focus(2)
	end, { description = "focus on LAPTOP screen", group = "screen" })
)
...
clientkeys = gears.table.join(
	...
	awful.key({ modkey }, "m", function(c)
		...
		c:raise()
	end, { description = "maximize toggle", group = "client" }),
  ...
  --]]
	...
	end, { description = "move client to CENTER screen", group = "client" }),

	awful.key({ modkey, "Shift" }, "Right", function(c)
		awful.client.movetoscreen(c, 2)
	end, { description = "move client to LAPTOP screen", group = "client" })
)
